...
- (void)setDrugInfo:(NSDictionary *)drugInfo {
    ...
    [self.medicineLabel setFrame:CGRectMake(self.image.frame.origin.x + self.image.frame.size.width + 10, self.nameLabel.frame.origin.y + self.nameLabel.frame.size.height - 2, SCREEN_WIDTH - (self.image.frame.origin.x + self.image.frame.size.width + 10) - 20, 40)];
